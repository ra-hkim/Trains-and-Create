...
- Event class: [BlockLeftClickedKubeEvent](https://github.com/KubeJS-Mods/KubeJS/tree/main/src/main/java/dev/latvian/mods/kubejs/block/BlockLeftClickedKubeEvent.java)
