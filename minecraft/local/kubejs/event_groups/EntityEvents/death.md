...
- Event class: [LivingEntityDeathKubeEvent](https://github.com/KubeJS-Mods/KubeJS/tree/main/src/main/java/dev/latvian/mods/kubejs/entity/LivingEntityDeathKubeEvent.java)
